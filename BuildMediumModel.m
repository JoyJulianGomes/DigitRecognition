function initial_params_unrolled = BuildMediumModel(Input_Layer_Size,...
                                                    Hidden_Layer_1_Size,...
                                                    Hidden_Layer_2_Size,...
                                                    Output_Layer_Size)
...
initial_Theta_3 = randInitializeWeights(Hidden_Layer_2_Size, Output_Layer_Size);

% Unroll parameters to use in optimizer function
initial_params_unrolled = [initial_Theta_1(:); initial_Theta_2(:); initial_Theta_3(:)];                     
end